...
export function Avatar(props) {
  const { nodes, materials, scene } = useGLTF(
    "/models/67b2031806a8c190a56e6cb7 (2).glb"
  );
  ...
  const { animations: idleAnimation } = useFBX(
    "/animations/animations/Standing Idle.fbx"
  );
  const { animations: angryAnimation } = useFBX(
    "/animations/animations/Standing Arguing.fbx"
  );
  const { animations: greetingAnimation } = useFBX(
    "/animations/animations/Waving.fbx"
  );

  idleAnimation[0].name = "Idle";

  angryAnimation[0].name = "Talking";
  ...
  useEffect(() => {
    // console.log("actionsanimation", actions[animation]);
...
useGLTF.preload("/models/67b2031806a8c190a56e6cb7 (2).glb");
